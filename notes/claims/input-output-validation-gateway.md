...
**Extends:**
- [[llm-systems-require-their-own-dedicated-zero|anssi-bsi.2 details the input/output validation gateway principle, which is one of the six dedicated ZT principles asser]]
