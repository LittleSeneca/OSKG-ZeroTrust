...
**Supports:**
- [[zt-no-implicit-trust-continuous-eval|The protect surface (shifting controls from perimeter to asset) is the architectural mechanism that eliminates implicit]]
